 ...
 */
static NSString * const kConsumerKey       = @"oLCNYaEEImfMjMV82yuLDg";
static NSString * const kConsumerSecret    = @"N2KQ3sToyMZUj5Ids948tViF61g";
static NSString * const kToken             = @"yD3zYYIoZysSrBVSJ8W2BLK5SpqJHgvG";
static NSString * const kTokenSecret       = @"P2x1MRsLousi0MlOBKz93gnrp4Y";
